...
public class ArtWorkController {
  ...
  public BaseResponse<RegArtWorkResponse> regArtWork(@RequestBody RegArtWorkRequest request) {
    return BaseResponse.onSuccess(
        GlobalErrorCode.CREATED,
        ArtWorkConverter.toRegArtWorkResponse(artWorkCommandService.regArtWork(request)));
  }
}
